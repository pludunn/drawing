#!/usr/bin/env bash
# Install Drawing Pad for Arch Linux and derivatives.
set -euo pipefail
...
sudo pacman -Sy --needed --noconfirm python tk curl
...
curl --fail --location "$REPO_URL/archdrawing.desktop" -o "$HOME/.local/share/applications/drawing-pad.desktop"
